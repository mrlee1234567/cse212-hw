...
public class SimpleQueue {
    ...
    private int Dequeue() {
        ...
        var value = _queue[0];//was 1 should be 0
        _queue.RemoveAt(0);//same here. the assignment said 2 errors, idk if these were the errors, because its nebulous if this should count as one error or two
        return value;
    }
}